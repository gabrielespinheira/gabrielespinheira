    ...
    <Reveal id="about" className="container flex items-start justify-center pb-24 pt-24">
      ...
      <div id="about-text" className="relative ml-16 max-w-[650px]">
        ...
        <p className="mb-8 text-lg leading-[170%]">
          ...
          record of delivering projects on time and within budget. I&apos;m a strong team
          player and enjoy collaborating with others to come up with innovative solutions
          to complex problems.
        </p>
